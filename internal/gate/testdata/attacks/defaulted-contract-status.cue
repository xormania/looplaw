// ATTACK — a defaulted disjunction where a value belongs.
//
// CUE calls a defaulted disjunction concrete, so this passed the shape
// gate: the relational lane read "ratified", the declaration recorded
// these bytes, and ratification copied them into a law version. The
// recorded law is then a choice rather than a value — unified with an
// overlay selecting the other arm, the same ratified bytes say the
// contract is withdrawn. Found by security audit of the master tree.
