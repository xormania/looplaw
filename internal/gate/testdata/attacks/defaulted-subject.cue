// ATTACK — the same default on the field that names the subject.
//
// The subject is what a declaration is recorded under and what
// ratification acts on, so a default here makes the identity of the law
// depend on what the reader unifies it with. Found by independent
// refutation during the same audit, against the defect the sibling
// attack states.
...
subject:        *"lend-library" | "other-library"
schema_version: "0"
