...
//
// Round 2 (decomposition): a precondition both client-owed and wire-fed left two satisfiers of record for one obligation, so blame could not name the failed one.
