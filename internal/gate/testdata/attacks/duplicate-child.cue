...
//
// Round 2 (decomposition): a child listed twice in one interior was refused only by accident, with a diagnosis that named the wrong defect.
...
contracts: {
	"C-LEND-1": {
		...
		status: "ratified"
		interior: {
			children: ["C-STANDING-1", "C-ISSUE-1", "C-STANDING-1"]
			wires: [
