...
//
// Round 1 (gate): a Cyrillic-a fork of a lexicon term coexisted with the original under contradictory definitions — a collision generator inside a collision-resistant lexicon.
