// ATTACK — an open list where the ratified elements belong.
//
// The cited invariants passed every gate, and ratification copied these
// bytes into a law version. Read alongside a set naming a longer list,
// the same ratified law cites an invariant no act ever bound the
// contract under: ["L-1"] becomes ["L-1", "L-99"] with no conflict.
// Found while drawing the line for the defaulted-disjunction attacks:
// the default is not the only form unification can change.
