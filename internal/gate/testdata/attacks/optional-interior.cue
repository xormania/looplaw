...
//
// Round 2 (decomposition): a child guarantee "feeding" its own precondition laundered any dangling requirement past the gate — one line defeated the whole dangling check.
...
contracts: {
	"C-LEND-1": {
		...
		interior?: {
			...
			wires: [
				{from: {child: "C-ISSUE-1", guarantee: "G-1"}, to: {child: "C-ISSUE-1", precondition: "P-1"}},
			]
			presents: {
